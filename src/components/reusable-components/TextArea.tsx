...
function TextArea({ name, value, onChange, placeholder }:TextAreaProps) {
  ...
  return (
    ...
    <textarea
        className=" text-sm appearance-none block w-full h-72 bg-gray-50 text-black border border-gray-500 rounded py-3 px-12 mb-3 leading-tight focus:outline-none focus:bg-white text-left overflow-auto"
